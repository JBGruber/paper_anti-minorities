...
```{r}
prompt <- "Analyze the following paragraph. Is this positive about LGBTQ rights, but negative about another minority? Think before you speak, but answer either {Yes} or {No} in the end (choose one)."
...
make_query <- function(txt) {
  map(txt, function(t) {
    tribble(
      ...
      "assistant", "This paragraph is positive about LGBTQ+ rights, but does not speak negativly about another minority.\n\n{No}",
      ...
      "assistant",  "This paragraph is positive about LGBTQ+ rights, but uses these rights to attack immigrants.\n\n{Yes}",
      "user", t
    )
  })
}
